...
class InterpreterTest {
    ...
    fun `evaluates string concatenation with string and number`() {
        ...
        // "Hello " + "World"
        val strConcat = interpreter.evaluate(
        ...
        // "Value: " + 10
        val strNum = interpreter.evaluate(
        ...
        // 5 + " apples"
        val numStr = interpreter.evaluate(
